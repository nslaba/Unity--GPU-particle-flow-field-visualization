...
public class example : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //newGameObject.transform.position = new Vector3(0, 0, 0); // set the position to (0,0,0)
        //newGameObject.transform.rotation = Quaternion.Euler(0, 90, 0); // set the rotation to (0,90,0)
